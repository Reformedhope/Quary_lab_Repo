...
# Supporting Query Method Documentation: # click hyerlink below., make sure returns do not get inside the for loop
"""
...
def problem_two(request):
   instructor = Instructor.objects.filter(hire_date__iso_year__lte = 2010).order_by('hire_date')
   print(instructor)
